      ...
      <div className={!user ? "filter blur-sm pointer-events-none" : ""}>
        <div className="flex flex-1 flex-col gap-4 p-6 pt-4 animate-fadeIn">
              ...
              >
                {faqItems.map((item, index) => (
                  <AccordionItem key={index} value={`item-${index}`}>
                    <AccordionTrigger className="text-left text-lg font-medium text-[#333]">
                      {item.question}
                    </AccordionTrigger>
                    <AccordionContent>
                      <div className="flex flex-col md:flex-row md:items-start md:space-x-6 space-y-4 md:space-y-0">
                        ...
                        {item.videoUrl && (
                          <div className="md:w-1/2 max-w-[640px]">
          ...
          <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <Link
                      key={index}
                      href={action.href}
                      className="p-4 border-2 border-[#e0e0e0] rounded-lg hover:bg-[#ffd400] hover:text-[#333] flex flex-col items-center gap-2 transition-all duration-200 group"
                    >
            ...
            <Card
              id="feature-request"
              className="md:col-span-2 shadow-md hover:shadow-lg transition-shadow duration-200"
            >
              <CardHeader className="bg-[#f0f0f0] text-[#333] rounded-t-lg">
                <CardTitle className="flex items-center gap-2 text-xl">
              ...
              <CardContent className="pt-4">
                <form onSubmit={handleFeatureRequestSubmit} className="space-y-4">
                  <div className="space-y-2">
                    <label htmlFor="featureTitle" className="block text-sm font-medium text-gray-700">
                      Feature name
                    </label>
                    <input
                      id="featureTitle"
            ...
            >
              ...
              <CardContent className="pt-4">
                <form onSubmit={handleSupportSubmit} className="space-y-4">
                  <div className="space-y-2">
                    <label htmlFor="supportTitle" className="block text-sm font-medium text-gray-700">
                      Issue Title
                    </label>
                    <input
                      id="supportTitle"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="supportDescription" className="block text-sm font-medium text-gray-700">
                      Issue Description
                    </label>
                    <textarea
