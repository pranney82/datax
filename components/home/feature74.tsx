...
const features: Feature[] = [
  ...
  },
  {
    ...
    id: 'automation',
    description: "Revolutionize your business processes with our Automation feature—integrating Zapier, custom formulas, and expert CTO consulting for unparalleled efficiency.",
    list: [
      'Zapier integrations',
      'Custom formulas',
      'CTO consulting'
  ...
  return (
    ...
    >
      <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col justify-between">
        <div>
          <h2 className="text-3xl font-extrabold mb-2 text-[#ffd400] leading-tight">
            {feature.title}
          </h2>
        ...
        <div className="hidden lg:block mt-6">
          <Link href={feature.link} passHref>
            <Button
              className="w-full bg-gradient-to-r from-[#FFD400] to-[#FFA500] text-black font-bold py-3 rounded-full transition-all duration-300 transform hover:scale-105 relative overflow-hidden group"
            >
