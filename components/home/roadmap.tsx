...
import { Sparkles, Clock, Zap, Rocket, CheckCircle2, ChevronDown, ChevronUp, type LucideIcon } from "lucide-react"
...
function FeatureCard({
  ...
  return (
    ...
    >
      <div
        className={`relative p-6 sm:p-8 bg-gradient-to-br ${color} rounded-lg shadow-lg overflow-hidden transition-all duration-300 group-hover:shadow-xl transform group-hover:-translate-y-1`}
      >
        <div className="absolute inset-0 bg-white opacity-90 group-hover:opacity-80 transition-opacity duration-300" />
        <div className="relative z-10">
          <h3 className="text-xl sm:text-lg font-bold mb-3 sm:mb-2 text-gray-800">{feature.title}</h3>
...
function KanbanColumn({ section }: { section: RoadmapSection }) {
  ...
  return (
    <div
      className={`flex-1 w-full sm:min-w-[250px] sm:max-w-[300px] bg-gradient-to-br ${section.color} rounded-lg p-4 sm:p-6 flex flex-col shadow-md`}
    >
