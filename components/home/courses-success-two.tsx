      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center bg-white rounded-xl p-8 shadow-2xl">
          ...
          >
            ...
            <div className="mt-8">
              <EpicButton title="Get First Worksheet" href="https://drive.google.com/file/d/1CC8mDgRH-K3Q2Q1INeiAVKr37KfT00mI/view?usp=sharing" variant="light" />
            </div>
          </motion.div>
        </div>
      </div>
...
export default CoursesSuccessTwo
